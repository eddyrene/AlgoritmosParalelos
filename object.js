...
var lesson_model = function(sco_json, lms_config, sco_number, lesson_config_json)
{
    ...
    if(typeof product_helper_check_level_localization == "function"){
        console.log(localize_json)
        localize_json = product_helper_check_level_localization(localize_json);
        console.log(localize_json)
    }
...
{    
    ...
    if(typeof lesson_config_json.exercise_common_instructions != 'undefined'){ //removed this in place of localized instructions for efs
    ...
    //do state for older products, new products have state on the product_exercise_model
    ...
    //new products have a feedback model (sena), so map that out
    if(lesson_config_json.feedback_type != 'gen')       
    {   
        //map product specific feedback functionality
